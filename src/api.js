...
export const testHub        = (url) => req('GET', `/hub-test?url=${encodeURIComponent(url)}`)
export const getShelfHubs   = () => req('GET', '/shelf-hubs')
export const setShelfHub    = (categoryId, hubUrl) => req('PUT', `/shelf-hubs/${categoryId}`, { hub_url: hubUrl })
export const migrateHub     = (fromUrl, toUrl) => req('POST', '/hub-migrate', { from_url: fromUrl, to_url: toUrl })
